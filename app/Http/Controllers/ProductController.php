...
class ProductController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $product->save();
        return redirect()->route('products.index')->with('success', 'Product Added succesfuly');
    }
    ...
    public function update(Request $request, Product $product) {
        ...
        return redirect()->route('products.index')->with('success', 'Product has been updated succesfully');
    }
